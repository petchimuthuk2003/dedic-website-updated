                ...
                <div className="glass-panel py-10 px-6 shadow-2xl rounded-[2rem] border-white/50 bg-white/60 sm:px-10">
                    <form className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-sm">
                                <a href="#" className="font-bold text-tech-blue hover:text-blue-700 transition-colors">
                                    Forgot password?
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-slate-500 text-sm font-medium">
                            ...
                            <Link to="/signup" className="font-bold text-tech-blue hover:text-blue-700 transition-colors">
                                Sign up for free
                            </Link>
                        </p>
                    </div>
